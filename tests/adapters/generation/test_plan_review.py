...
class TestReviewOnce:
    def test_review_once_calls_api_with_system_prompt_and_thinking_config(self) -> None:
        ...
        if _PLAN_REVIEW_SYSTEM_PROMPT:
            assert (
                request_body["systemInstruction"]["parts"][0]["text"] == _PLAN_REVIEW_SYSTEM_PROMPT
            )
        else:
...
class TestRunRepl:
    def test_run_repl_skips_blank_lines_and_stops_on_quit(
        ...
        with (
            ...
            patch(
                "adapters.generation.plan_review._review_once",
        ...
        mock_review_once.assert_called_once()
    ...
    def test_run_repl_stops_on_done(self) -> None:
        ...
        with (
            ...
            patch("adapters.generation.plan_review._review_once") as mock_review_once,
        ):
            _run_repl(
                session_context=session_context,
                resolved_model=resolved_model,
        ...
        mock_review_once.assert_not_called()
